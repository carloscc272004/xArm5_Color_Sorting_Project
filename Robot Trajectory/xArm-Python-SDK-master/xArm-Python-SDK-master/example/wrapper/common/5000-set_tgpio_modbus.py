...
# enable bio gripper
code, ret = arm.getset_tgpio_modbus_data([0x08, 0x06, 0x01, 0x00, 0x00, 0x01], host_id=9)
print('set_bio_gripper_enable, code={}, ret={}'.format(code, ret))

# set bio gripper speed
speed = 1000
code, ret = arm.getset_tgpio_modbus_data([0x08, 0x06, 0x03, 0x03, speed // 256 % 256, speed % 256], host_id=9)
print('set_bio_gripper_speed, code={}, ret={}'.format(code, ret))

while arm.connected and arm.error_code == 0:
    code, ret = arm.getset_tgpio_modbus_data([0x08, 0x10, 0x07, 0x00, 0x00, 0x02, 0x04, 0x0, 0x0, 0x0, 0x82], host_id=9)
